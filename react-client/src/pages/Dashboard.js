        ...
        <div className="Main">
            <header className='header'>
                <div className='headerItems'>
                    <div className="eventDetailsHeader">
                        <h2>{events.details.eventName}</h2>
                        <h3>Host Name: {events.details.hostName}</h3>
                        {
                            events.details.live ?
                    ...
                    <div>
                        <h1>Join Code: {events.details.eventCode}</h1>
                    </div>
            ...
            <div className="mainBody">
                <div className="moodContainer veryBad">
                    <h2>General Mood:</h2>
                    <h3> {results !== undefined ? results.generalMood : "N/A"} </h3>
                    {results === undefined ? <img src={neutral}/> :
                        results.generalMood === "very bad" ? <img src={veryBad} /> : results.generalMood === "bad" ? <img src={bad}/> : results.generalMood === "neutral" ? <img src={neutral}/> : results.generalMood === "good" ? <img src={good}/> : <img src={veryGood}/>
                    }
